...
def detect_face(img):
    ...
    #return gray[0:200, 0:200], faces[0]
...
face_recognizer.save('trainner/trainnerLBPHFace.yml')
#face_recognizer.save('trainner/trainnerEigenFace.yml')
#face_recognizer.save('trainner/trainnerFisherFace.yml')
